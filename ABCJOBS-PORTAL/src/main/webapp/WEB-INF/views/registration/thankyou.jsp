...
<div class="container" style="font-family: 'Roboto Slab', serif;">
   <div class="" style="color:white">
    <h1 class="fs-1 fst-italic text-center mt-5 mb-4 d-flex align-items-center justify-content-center text-wrap" id="nameText">Thank you <span id="fullName">${firstName} ${lastName}</span> for joining ABCJobs</h1>

<script>
  // Get the span element containing the full name
  const fullNameElement = document.getElementById("fullName");

  // Set the color to #2bcbba
  fullNameElement.style.color = "#2bcbba";
</script>

    <h2 class="fs-2 fst-italic d-flex align-items-center justify-content-center mb-5">Discover your ideal career within our network</h2>
